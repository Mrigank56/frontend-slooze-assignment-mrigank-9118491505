...
const UPDATE_PRODUCT_MUTATION = gql`
  mutation UpdateProduct($id: Int!, $name: String, $price: Float, $stock: Int) {
    updateProduct(
      updateProductInput: { id: $id, name: $name, price: $price, stock: $stock }
    ) {
      id
      name
      price
        ...
        <div className="max-w-xl bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-300 dark:border-gray-800 p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="pt-4 flex items-center justify-end gap-3">
              ...
              <button
                type="submit"
                disabled={updateLoading || success}
